...
class Test_Uni(unittest.TestCase):
    ...
    def test_uni_method1(self):
        self.assertEqual(self.uni.uni_method("мгу", "", "", ""), "До встречи")

    def test_uni_method2(self):
        self.assertEqual(self.uni.uni_method("мирэа", "нет", "", ""), "Очень жаль ")

    def test_uni_method3(self):
        self.assertEqual(self.uni.uni_method("мирэа", "да", "нет", ""), "Отлично, ты знаешь что-то")
